...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: #e5f6f5; /* Light background */
    color: #071a19;  Text Color */
            margin: 0;
        }
...
<div class="container">
    ...
    <div class="item">
	<div>
        <h1 class="title-item"><?= $painting['name'] ?></h1>
		 <div class="h3">Price Per Piece: P<?= $painting['perPiece'] ?></div>
        <div class="h3">Price Per Kilo: P<?= $painting['perKilo'] ?></div>
		</div>
        <div class="image-item">
            <img src="images/<?= $painting['image'] ?>" alt="<?= $painting['name'] ?>">
        </div>
