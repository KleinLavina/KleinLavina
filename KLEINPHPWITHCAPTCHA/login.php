    ...
    <div style="width:400px; border: solid 1px #4CAF50; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);" align="left">
        ...
        <div style="margin:20px; padding:10px; background-color: #E9F3B0; color: #2C3E50;">
             <form action="check_login.php" method="post">
				...
				<img id="imgcap" onclick="reloadCaptcha();return false;" src="inc/captcha.php" alt="CAPTCHA" width="150" height="20"><br/>
				<label style="font-weight: bold;">CAPTCHA:</label><br />
                ...
                <input type="submit" value="Submit" style="width: 100%; padding: 10px; background-color: #4CAF50; color: #FFFFFF; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;"/>
            </form>
